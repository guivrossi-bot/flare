...
const APP_WHY = {
  en: {
    tankPlates: "Oxyfuel cutting on tank floor and roof plates requires preheat, generates a wide heat-affected zone, and causes plate warping — especially on thin 3/16\" carbon steel. Plasma cuts the same material instantly, with a narrower HAZ, producing edges ready for welding without grinding. A Petrobras field study at the RECAP refinery confirmed a 54% overall cost reduction when switching 20 sheets from oxyfuel to plasma (PowerMax 105 Sync), including labor, gas, and equipment costs.",
    nozzleRemoval: "Removing nozzles from pressure vessels and HDT reactors with abrasive disc cutting on thick stainless steel (up to 60mm) is extremely slow and creates significant risk of shell damage. In a validated test at a Petrobras refinery, plasma (MaxPro 200A) completed the removal of four 309L stainless steel nozzles at 60mm thickness in just 12 hours — compared to the original estimate of 60 hours using disc cutting. The affected area was reduced by approximately 50%, and the equipment returned to service ahead of the supplier's forecast.",
    boilerSupports: "During scheduled maintenance shutdowns, boiler tube supports in confined spaces must be cut and replaced using whatever tools fit the access constraints. Abrasive disc cutting in these conditions is slow and labor-intensive. A plasma cutting test at the RPBC refinery replacing 50 supports during a scheduled shutdown reduced execution time by approximately 60%, removing a critical bottleneck from the maintenance schedule.",
  ...
  es: {
    tankPlates: "El corte con oxicombustible en chapas de pisos y techos de tanques requiere precalentamiento, genera una zona afectada por calor amplia y causa deformación de las chapas, especialmente en acero carbono de 3/16\". Un estudio de campo de Petrobras en la refinería RECAP confirmó una reducción del 54% en costos al cambiar de oxicombustible a plasma en 20 chapas.",
    nozzleRemoval: "La remoción de boquillas de recipientes a presión con disco abrasivo en acero inoxidable grueso (hasta 60mm) es extremadamente lenta. En una prueba en una refinería Petrobras, el plasma completó la remoción de cuatro boquillas de 309L a 60mm en solo 12 horas versus el estimado original de 60 horas con disco abrasivo.",
    boilerSupports: "Durante paradas programadas de mantenimiento, los soportes de tubos de calderas en espacios confinados deben cortarse y reemplazarse. Una prueba de plasma en la refinería RPBC reemplazando 50 soportes redujo el tiempo de ejecución aproximadamente un 60%, eliminando un cuello de botella crítico.",
  ...
  pt: {
    tankPlates: "O corte a oxicombustível em chapas de pisos e tetos de tanques requer pré-aquecimento, gera uma zona termicamente afetada ampla e causa empenamento das chapas, especialmente no aço carbono de 3/16\". Um estudo de campo da Petrobras na refinaria RECAP confirmou redução de 54% nos custos ao trocar oxicombustível por plasma em 20 chapas.",
    nozzleRemoval: "A remoção de bocais de vasos de pressão com disco abrasivo em aço inoxidável espesso (até 60mm) é extremamente lenta. Em um teste validado em refinaria Petrobras, o plasma completou a remoção de quatro bocais de aço 309L a 60mm em apenas 12 horas, versus a estimativa original de 60 horas com disco abrasivo.",
    boilerSupports: "Durante paradas programadas de manutenção, os suportes de tubos de caldeiras em espaços confinados precisam ser cortados e substituídos. Um teste de plasma na refinaria RPBC substituindo 50 suportes reduziu o tempo de execução em aproximadamente 60%, removendo um gargalo crítico do cronograma de manutenção.",
...
export function generatePDF({ apps, calcData, unit, lang, userInfo }) {
  ...
  const L = {
    en: {
      ...
      about1: "This report was generated using Flare — a plasma cutting savings calculator developed by Industrial Cutting Labs, based on field data collected by Hypertherm Associates in partnership with Petrobras during the study \"Plasma Cutting Technology Applied to Maintenance Operations in Oil Refineries\" (Phase 1, 2024).",
      ...
      dataSource: "Data source: Hypertherm Associates — \"Plasma Cutting Technology Applied to Maintenance Operations in Oil Refineries\", Phase 1 (2024). Field tests conducted at Petrobras RECAP, RPBC, and partner refineries in Brazil.",
    ...
    es: {
      ...
      about1: "Este informe fue generado usando Flare — una calculadora de ahorros en corte plasma desarrollada por Industrial Cutting Labs, basada en datos de campo recopilados por Hypertherm Associates en asociación con Petrobras durante el estudio \"Tecnología de Corte por Plasma Aplicada a Operaciones de Mantenimiento en Refinerías de Petróleo\" (Fase 1, 2024).",
      ...
      dataSource: "Fuente de datos: Hypertherm Associates — \"Tecnología de Corte por Plasma Aplicada a Operaciones de Mantenimiento en Refinerías de Petróleo\", Fase 1 (2024). Pruebas de campo en refinerías RECAP, RPBC y otras de Petrobras en Brasil.",
    ...
    pt: {
      ...
      about1: "Este relatório foi gerado usando o Flare — uma calculadora de economias em corte a plasma desenvolvida pela Industrial Cutting Labs, baseada em dados de campo coletados pela Hypertherm Associates em parceria com a Petrobras durante o estudo \"Tecnologia de Corte a Plasma Aplicada a Operações de Manutenção em Refinarias de Petróleo\" (Fase 1, 2024).",
      ...
      dataSource: "Fonte de dados: Hypertherm Associates — \"Tecnologia de Corte a Plasma Aplicada a Operações de Manutenção em Refinarias de Petróleo\", Fase 1 (2024). Testes de campo nas refinarias RECAP, RPBC e outras da Petrobras no Brasil.",
