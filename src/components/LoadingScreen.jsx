...
const FACTS = {
  en: [
    ...
    "Over 90% of cutting in oil refineries still relies on oxyfuel or abrasive disc methods.",
    ...
    "Switching to plasma on tank plate cutting delivered a 54% overall cost reduction.",
    "Plasma cuts stainless steel cleanly — no pre-treatment required on 304L, 309L or 316L.",
  ],
  es: [
    "El plasma redujo una remoción de boquillas de 60 horas a solo 12 horas.",
    "Más del 90% del corte en refinerías aún usa oxicombustible o disco abrasivo.",
    ...
    "El cambio a plasma en corte de chapas de tanques entregó una reducción del 54% en costos.",
    "El plasma corta acero inoxidable limpiamente — sin pretratamiento en 304L, 309L o 316L.",
  ],
  pt: [
    "O plasma reduziu uma remoção de bocais de 60 horas para apenas 12 horas.",
    "Mais de 90% do corte em refinarias ainda usa oxicombustível ou disco abrasivo.",
    ...
    "A troca para plasma no corte de chapas de tanques entregou redução de 54% nos custos.",
    "O plasma corta aço inoxidável sem pré-tratamento — 304L, 309L e 316L incluídos.",
  ],
};
